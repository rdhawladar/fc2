...
{     
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    	...
    	echo '<br/>';
        $pp = explode('//' , $thumbnail_data[2]);
        echo $thumbnail = 'http://'. $pp[1];		
    ...
    {
      	$filter_title     = "h3";// "div > .panel-heading";//"h3";
    	$filter_thumbnail = "meta";
        $client1 = new Client();
        $goutteClient1 = new Client();
        $guzzleClient1 = new GuzzleClient(array(
		...
		$thumbnail_data = $crawler1->filter("img")->each(function ($node) {
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    {
		$titleUrl = "https://movie.eroterest.net/video/page/234/";
      	$filter_title     = "div > .panel-heading";//"h3";
    	$filter_thumbnail = "meta";
        $client1 = new Client();
        $goutteClient1 = new Client();
        $guzzleClient1 = new GuzzleClient(array(
        ...
        echo $title = $title_data[0]  ; 
		echo '<br/>';
        echo $thumbnail = "https:".$thumbnail_data[0] ;
