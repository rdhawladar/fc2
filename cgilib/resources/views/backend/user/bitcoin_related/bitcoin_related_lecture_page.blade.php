  ...
  <div class="content-wrapper">
	...
	<div class="row">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
				...
				<div class="form-group">
					...
					<input class="btn btn-info" id="comment_for_this_video2"  value="Submit Your Comment For This Video"  type="button">
				</div>
            </div>
          </div>
        </div>
        @endforeach
                   ...
                   <div  class="modal modal-primary fade" id="myModal2">
    ...
    <script>
	     $(function(){
	        $(document).on("click","#comment_for_this_video2",function(){
	            $("#myModal2").modal("show");
	        }); 
	     });
	 </script>
