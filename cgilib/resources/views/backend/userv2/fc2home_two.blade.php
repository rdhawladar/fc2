                  ...
                  <div class="x_content">
		             ...
		             <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $one['id'] .'/6') }}" target="_blank">{{ $one['title_url'] }}</a>
                        <p>{{ $one['url'] }}
                        </br>
                       {{ $downloadLinks[0] }}
                     <br/>
							...
							<a href="{{ url('/user/change-task-status/'.$ud.'/'. $one['id'] .'/'.$date) }}" class="btn btn-xs btn-success">Done</a>
								...
								@endif
								   <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $one['id'] .'/6') }}" target="_blank">Download Thumbnail</a>
		            ...
		            <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $two['id'] .'/7') }}" target="_blank">{{ $two['title_url'] }}</a>
                        <p>{{ $two['url'] }}
                        </br>
                     {{ $downloadLinks[1] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								@if($two['status'] == 'pending')
								<a href="{{ url('/user/change-task-status/'.$ud.'/'.$two['id'] .'/'.$date) }}" class="btn btn-xs btn-success">Done</a>
									@else
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								   <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $two['id'] .'/7') }}" target="_blank">Download Thumbnail</a>
		            ...
		            <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $three['id'] .'/8') }}" target="_blank">{{ $three['title_url'] }}</a>
                        <p>{{ $three['url'] }}
                        </br>
                    {{ $downloadLinks[2] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								@if($three['status']  == 'pending')
							<a href="{{ url('/user/change-task-status/'.$ud.'/'. $three['id'] . '/'.$date) }}" class="btn btn-xs btn-success">Done</a>
								@else
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								     <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $three['id'] .'/8') }}" target="_blank">Download Thumbnail</a>
...
@if(isset($downloadLinks[3])) 
		            <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $four['id'] .'/9') }}" target="_blank">{{ $four['title_url'] }}</a>
                        <p>{{ $four['url'] }}
                        </br>
                    {{ $downloadLinks[3] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								@if($four['status']  == 'pending')
							<a href="{{ url('/user/change-task-status/'.$ud.'/'. $four['id'] .'/'.$date) }}" class="btn btn-xs btn-success">Done</a>
								@else
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								     <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $four['id'] .'/9') }}" target="_blank">Download Thumbnail</a>
		            ...
		            <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $five['id'] .'/10') }}" target="_blank">{{ $five['title_url'] }}</a>
                        <p>{{ $five['url'] }}
                        </br>
                    {{ $downloadLinks[4] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								@if($five['status']  == 'pending')
							<a href="{{ url('/user/change-task-status/'.$ud.'/'. $five['id'] .'/'.$date) }}" class="btn btn-xs btn-success">Done</a>
								@else
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								     <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $five['id'] .'/10') }}" target="_blank">Download Thumbnail</a>
...
<style>
			...
			<p>
                    ...
                    <li><a class="btn btn-xs btn-danger" href="{{ url('/user/home/two') }}">2</a></li>
                    ...
                    <li><a class="btn btn-xs btn-success" href="{{ url('/user/home/six') }}">6</a></li>
