          ...
          <div class="">
                  ...
                  <div class="x_content">
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $one['id'] .'/1') }}" target="_blank">{{ $one['title_url'] }}</a>
                        <p>{{ $one['url'] }}
                        </br>
                        @if(isset($downloadLinks[0]))
                        	...
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								@endif
								<a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $one['id'] .'/1') }}" target="_blank">Donwload Thumbnail</a>
                    ...
                    <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $two['id'] .'/2') }}" target="_blank">{{ $two['title_url'] }}</a>
                        <p>{{ $two['url'] }}
                        </br>
                    ...
                    {{ $downloadLinks[1] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
							    <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $two['id'] .'/2') }}" target="_blank">Download Thumbnail</a>
           ...
           @endif
                ...
                <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $three['id'] .'/3') }}" target="_blank">{{ $three['title_url'] }}</a>
                        <p>{{ $three['url'] }}                        
                        </br>
                    ...
                    {{ $downloadLinks[2] }}<br/>                 
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								     <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $three['id'] .'/3') }}" target="_blank">Donwload Thumbnail</a>
					...
					<article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $four['id'] .'/4') }}" target="_blank">{{ $four['title_url'] }}</a>
                        <p>{{ $four['url'] }}                        
                        </br>
                        	...
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								       <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $four['id'] .'/4') }}" target="_blank">Donwload Thumbnail</a>
					...
					<article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $five['id'] .'/5') }}" target="_blank">{{ $five['title_url'] }}</a>
                        <p>{{ $five['url'] }}                        
                        </br>
                        	...
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								<a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $five['id'] .'/5') }}" target="_blank">Donwload Thumbnail</a>                
							</form>
