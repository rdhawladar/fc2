                  ...
                  <div class="x_content">
			 		...
			 		@if(isset($downloadLinks[0])) 
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $one['id'] .'/11') }}" target="_blank">{{ $one['title_url'] }}</a>
                        <p>{{ $one['url'] }}
                        </br>
                     {{ $downloadLinks[0] }}<br/>
							...
							<a href="{{ url('/user/change-task-status/'.$ud.'/'.$one['id'] .'/'.$date) }}" class="btn btn-xs btn-success">Done</a>
								...
								@endif
								   <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $one['id'] .'/11') }}" target="_blank">Download Thumbnail</a>
                    ...
                    @if(isset($downloadLinks[1])) 
                     <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $two['id'] .'/12') }}" target="_blank">{{ $two['title_url'] }}</a>
                        <p>{{ $two['url'] }}
                        </br>
                     {{ $downloadLinks[1] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								<a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $two['id'] .'/12') }}" target="_blank">Download Thumbnail</a>
                    ...
                    @if(isset($downloadLinks[2])) 
                     <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $three['id'] .'/13') }}" target="_blank">{{ $three['title_url'] }}</a>
                        <p>{{ $three['url'] }}
                        </br>
                     {{ $downloadLinks[2] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
							   <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $three['id'] .'/13') }}" target="_blank">Download Thumbnail</a>
					...
					@if(isset($downloadLinks[3])) 
                     <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $four['id'] .'/14') }}" target="_blank">{{ $four['title_url'] }}</a>
                        <p>{{ $four['url'] }}
                        </br>
                     {{ $downloadLinks[3] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								 <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $four['id'] .'/14') }}" target="_blank">Download Thumbnail</a>
					...
					@if(isset($downloadLinks[4])) 
                     <article class="media event">
                      ...
                      <div class="media-body">
                        <a class="title" href="{{ url('/user/copy-url/'. $five['id'] .'/15') }}" target="_blank">{{ $five['title_url'] }}</a>
                        <p>{{ $five['url'] }}
                        </br>
                     {{ $downloadLinks[4] }}<br/>
                        	<form method="post" action="{{ url('/user/file-download') }}">
								...
								<i class="fa fa-thumbs-o-up"></i>
								@endif
								 <a class="btn btn-xs btn-info" href="{{ url('/user/copy-url/'. $five['id'] .'/15') }}" target="_blank">Download Thumbnail</a>
...
<style>
			...
			<p>
                    ...
                    <li><a class="btn btn-xs btn-danger" href="{{ url('/user/home/three') }}">3</a></li>
