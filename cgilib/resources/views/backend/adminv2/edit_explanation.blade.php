              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ url('/admin/message-edits') }}">
                    {{  csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <textarea class="form-control" id="message_one" rows="8" placeholder="Enter Explanation Detail" name="message_one">{{ $msg->msg1 }}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <textarea class="form-control" id="message_two" rows="8" placeholder="Enter Explanation Detail" name="message_two">{{ $msg->msg2 }}</textarea>
							  <script type="text/javascript" >	 
