...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <script src="../kachamal/js/custom.js"></script>


	
	<!-- Datatable Integratio 
	http://jsfiddle.net/hojpyahy/
	...
	$(function(){
	   var dataTable = $('#datatable-responsive').DataTable({
		/*
		language: {
			//top right search box label
			search: 'アカ系旧なぐ。:' ,			
			//left top combo per page with text
			sLengthMenu: "知世子 _MENU_ 森田" ,
			//bottom left side information change
			// sInfo: "齢構満帯 _START_ _END_ _TOTAL_  _MAX_", 
		},
		paginate: {
			sFirst:    "الأول",
			sPrevious: "السابق",
		...
		*/
		...
		serverSide: true,
		bSort	  : false,		
		//http://127.0.0.1/crazysns/admin/members-list-data-table
		ajax: "result.json",
		columns: [
			{ data: 'id'	  	    , name: 'name' },
			{ data: 'email'		    , name: 'email' },
			{ data: 'readable_password' , name: 'password' },
